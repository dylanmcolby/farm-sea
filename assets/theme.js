...
$('.vertical__slider').slick({
  ...
  slidesToScroll: 6,
  vertical: true,
  prevArrow:'<button type="button" class="btn arrow__up"><img src="https://cdn.shopify.com/s/files/1/2511/0532/files/icon-arrow-down.png?v=1631513849" alt="icon arrow down">',
  nextArrow:'<button type="button" class="btn arrow__down"><img src="https://cdn.shopify.com/s/files/1/2511/0532/files/icon-arrow-down.png?v=1631513849" alt="icon arrow down"></button>'
